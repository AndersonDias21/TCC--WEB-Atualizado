...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:TextBox BorderColor="White" ForeColor="Red" ID="mensagemErroNome" Enabled="false" Visible="false" runat="server" Height="16px" Width="314px">*</asp:TextBox><br />
    ...
    <asp:TextBox BorderColor="White" ForeColor="Red" ID="mensagemErroSenha" Enabled="false" Visible="false" runat="server" Height="16px" Width="314px">*</asp:TextBox><br />
    ...
    <asp:TextBox BorderColor="White" ForeColor="Red" ID="mensagemErroConfirmarSenha" Enabled="false" Visible="false" runat="server" Height="16px" Width="314px">*</asp:TextBox><br />
...
<asp:TextBox style="margin-left: 5px" type="text" runat="server" ID="txtCep" ></asp:TextBox>
    <asp:TextBox BorderColor="White" ForeColor="Red" ID="mensagemErroCep" Enabled="false" Visible="false" runat="server" Height="16px" Width="314px">*</asp:TextBox><br />
  ...
  <asp:TextBox style="margin-left: 5px" type="text" runat="server" ID="txtEndereco"></asp:TextBox>
    <asp:TextBox BorderColor="White" ForeColor="Red" ID="mensagemErroEndereco" Enabled="false" Visible="false" runat="server" Height="16px" Width="314px">*</asp:TextBox><br />
    ...
    <asp:TextBox BorderColor="White" ForeColor="Red" ID="mensagemErroBairro" Enabled="false" Visible="false" runat="server" Height="16px" Width="314px">*</asp:TextBox><br />
    ...
    <asp:TextBox BorderColor="White" ForeColor="Red" ID="mensagemErroCidade" Enabled="false" Visible="false" runat="server" Height="16px" Width="314px">*</asp:TextBox><br />
    ...
    <asp:TextBox BorderColor="White" ForeColor="Red" ID="mensagemErroEstado" Enabled="false" Visible="false" runat="server" Height="16px" Width="314px">*</asp:TextBox><br />
